...
export const metadata = {
  ...
  description:
    "Standard, Premium und Awesome: drei Stufen für deine Webseite — von der klaren Landingpage bis zu Buchung und Reservierung.",
};

export default function PortfolioV2Page() {
  return (
    <div className="mesh-bg min-h-[50vh]">
      <PageHero eyebrow="Portfolio" title="Drei Modelle. Ein Ziel: deine perfekte Seite.">
        <p>
